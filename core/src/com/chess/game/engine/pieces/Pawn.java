...
public class Pawn extends Piece {
    ...
    private final static int[] CANDIDATE_MOVE_CORDINATES = {8, 16, 7, 9};
    ...
    public Collection<Move> calculateLegalMoves(Board board) {
        ...
        for(final int currentCandidateOffset : CANDIDATE_MOVE_CORDINATES) {
            ...
            if (currentCandidateOffset == 8 && !board.getTile(candidateDestinationCoordinate).isTileOccupied()) {
                // TODO сделать больше с продвижением
                ...
                if (!board.getTile(behindDestinationCoordinate).isTileOccupied() && !board.getTile(candidateDestinationCoordinate).isTileOccupied()) {
                    legalMoves.add(new MajorMove(board, this, candidateDestinationCoordinate));
                }
